...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania, dexia | P0 | 🟪 EN_REVISION — mapa único ✅, enlaces 33→7 ✅, subrayado fiel al origen ✅. **REVIEW-002 ⚠️: quitar `is-active`.** El árbol está a medias: falta el Pug | 2026-09-08 |
| [REVIEW-002](REVIEW-002-task-005-navegacion.md) | REVIEW | Navegación y enlaces — mapa único y estado accesible | dexia | ania, clia | P0 | ⚠️ APROBADO CON CAMBIOS — un ajuste semántico pendiente | 2026-09-08 |
