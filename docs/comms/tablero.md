...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único y enlaces reales | claude | antigravity | P0 | 🟦 ABIERTA — 33 `href='#'` en 17 archivos y sólo 6 enlaces internos reales. 🔴 toca `config.pug` y el layout. **Bloqueante: Miguel decide si se renombran `cart.html` / `cart-index.html`** | 2026-09-08 |
