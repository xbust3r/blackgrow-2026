...
| [TASK-006](TASK-006-listado-de-tienda.md) | TASK | Listado de tienda, insignias y borde punteado animado | clia | ania, dexia | P1 🔴 | 🟩 Alcance **FIRMADO**. Bloqueo resuelto: Miguel confirma **Blackgrow**. Falta que Ania revierta `config.pug:74` y mergee | 2026-09-08 |
