...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania, dexia | P0 | ⚠️ REVIEW-002: `is-active` resuelto; falta evidencia visual servida a 375px y escritorio, después sign-off 🔴 de Clia | 2026-09-08 |
| [REVIEW-002](REVIEW-002-task-005-navegacion.md) | REVIEW | Navegación y enlaces — mapa único y estado accesible | dexia | ania, clia | P0 | ⚠️ APROBADO CON CAMBIOS — pendiente comprobación visual en preview | 2026-09-08 |
