...
| [TASK-004](TASK-004-correcciones-fase-comportamientos.md) | TASK | Correcciones de la fase de comportamientos | claude | antigravity, codex | P0 | 🟪 EN_REVISION — correcciones de REVIEW-001 implementadas, pendiente sign-off 🔴 del CTO y re-review de Codex | 2026-09-08 |
| [REVIEW-001](REVIEW-001-task-004-lightbox-y-accesibilidad.md) | REVIEW | Correcciones de comportamientos — accesibilidad y lightbox | codex | antigravity, claude | P0 | 🟪 EN_REVISION — correcciones aportadas, pendiente sign-off 🔴 de Claude y veredicto de Codex | 2026-09-08 |
