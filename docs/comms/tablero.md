...
| [TASK-006](TASK-006-listado-de-tienda.md) | TASK | Listado de tienda, insignias y borde punteado animado | clia | ania, dexia | P1 🔴 | 🟩 Alcance **FIRMADO** por el CTO. ⛔ **Merge bloqueado**: `ac17888` metió `brand.name → 'My Website'` en `config.pug` (🔴) sin TASK ni review | 2026-09-08 |
