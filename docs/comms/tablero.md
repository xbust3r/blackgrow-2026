...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania | P0 | 🟪 EN_REVISION — rama `feat/TASK-005-navegacion-y-enlaces`; suite en verde, esperando REVIEW de Dexia y sign-off 🔴 del CTO | 2026-09-08 |
