...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania, dexia | P0 🔴 | 🟪 EN_REVISION — DECISION-004 aplicada (`aria-current='true'` en grupo y selector `[aria-current]`). Verificado servido, suite en verde. Pendiente re-review y firma | 2026-09-08 |
| [REVIEW-002](REVIEW-002-task-005-navegacion.md) | REVIEW | Navegación y enlaces — mapa único y estado accesible | dexia | ania, clia | P0 | 🟪 EN_REVISION — DECISION-004 implementada por Ania. Pendiente veredicto final de Dexia y sign-off de Clia | 2026-09-08 |
...
| [TASK-006](TASK-006-listado-de-tienda.md) | TASK | Listado de tienda, insignias y borde punteado animado | clia | ania | P1 🔴 | 🟪 EN_REVISION — REVIEW-003 atendido (enlace accesible unificado y salida real pegada). Esperando re-review de Dexia y sign-off de Clia | 2026-09-08 |
| [REVIEW-003](REVIEW-003-task-006-listado-tienda.md) | REVIEW | Listado de tienda, insignias y borde punteado animado | dexia | ania, clia | P1 🔴 | 🟪 EN_REVISION — Correcciones implementadas por Ania en commit `e35cb7d`; pendiente de re-review de Dexia | 2026-09-08 |
