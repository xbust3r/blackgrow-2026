...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania, dexia | P0 | 🟪 EN_REVISION — Evidencia visual aportada (preview 5274 activo, 375px y escritorio con foco teclado). Pendiente veredicto final Dexia y sign-off Clia | 2026-09-08 |
| [REVIEW-002](REVIEW-002-task-005-navegacion.md) | REVIEW | Navegación y enlaces — mapa único y estado accesible | dexia | ania, clia | P0 | ⚠️ APROBADO CON CAMBIOS — Evidencia visual entregada con preview en 5274. Pendiente ✅ final y sign-off | 2026-09-08 |
