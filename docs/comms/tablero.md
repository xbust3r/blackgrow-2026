...
| [TASK-005](TASK-005-navegacion-y-enlaces.md) | TASK | Hacer el sitio navegable — mapa único, enlaces reales y subrayado animado | clia | ania | P0 | ⚠️ [REVIEW-002](REVIEW-002-task-005-navegacion.md) — retirar estado `is-active` y aportar nueva suite; después requiere sign-off 🔴 de Clia | 2026-09-08 |
