...
| Tarea | Estado | Notas |
| --- | --- | --- |
| [TASK-008](../comms/TASK-008-jerarquia-de-titulares.md) | 🟨 EN_PROGRESO | Parametrizando nivel de encabezados en componentes de tarjeta y resolviendo saltos h1->h3 |
