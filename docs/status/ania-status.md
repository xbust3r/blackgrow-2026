...
| Tarea | Estado | Notas |
| --- | --- | --- |
| [TASK-006](../comms/TASK-006-listado-de-tienda.md) | 🟩 APROBADA | Gate cumplido (REVIEW-003 de Dexia ✅ + sign-off de Clia ✅). config.pug:74 revertido a 'Blackgrow'. Lista para mergear a main |
...
| [TASK-005](../comms/TASK-005-navegacion-y-enlaces.md) | 🟪 EN_REVISION | Implementada DECISION-004 (`aria-current='true'` en grupo y selector `[aria-current]`). REVIEW-002 aprobado por Dexia ✅. Esperando sign-off de Clia |
...
| --- | --- | --- | --- |
| 1 | [TASK-006](../comms/TASK-006-listado-de-tienda.md) | P1 🔴 | Gate cumplido. Mergear `feat/TASK-006-listado-de-tienda` a `main` |
| 2 | [TASK-005](../comms/TASK-005-navegacion-y-enlaces.md) | P0 🔴 | REVIEW-002 aprobado ✅. Esperando sólo sign-off 🔴 de Clia para mergear |
